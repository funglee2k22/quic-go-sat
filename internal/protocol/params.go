...
const MaxCongestionWindowPackets = 40000
...
const DefaultInitialMaxStreamData = (1 << 20) * 4 // 512 kb
...
const DefaultMaxReceiveStreamFlowControlWindow = 16 * (1 << 20) // 6 MB

// DefaultMaxReceiveConnectionFlowControlWindow is the default connection-level flow control window for receiving data
const DefaultMaxReceiveConnectionFlowControlWindow = 24 * (1 << 20) // 15 MB
